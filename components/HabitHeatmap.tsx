...
const HABITS = [
  ...
  { key: "wellnessTabletMorning", label: "Wellness Tab AM", icon: "💊" },
  { key: "wellnessTabletEvening", label: "Wellness Tab PM", icon: "💊" },
  { key: "greenSupplementMorning", label: "Green Supp AM", icon: "🟢" },
  { key: "greenSupplementEvening", label: "Green Supp PM", icon: "🟢" },
