...
const HABITS: HabitDef[] = [
  ...
  { key: "wellnessTabletMorning", label: "Wellness Tablet", subtitle: "Meal 1", icon: "💊" },
  { key: "wellnessTabletEvening", label: "Wellness Tablet", subtitle: "Meal 2", icon: "💊", minMeals: 2 },
  { key: "greenSupplementMorning", label: "Green Supplement", subtitle: "Meal 1", icon: "🟢" },
  { key: "greenSupplementEvening", label: "Green Supplement", subtitle: "Meal 2", icon: "🟢", minMeals: 2 },
...
const GROUPS = [
  { label: "Morning", keys: ["morningRitual"] },
  {
    ...
    keys: [
      ...
      "wellnessTabletMorning", "wellnessTabletEvening",
      "greenSupplementMorning", "greenSupplementEvening",
